...
class PurchaseReturn extends StatefulWidget {
  ...
  int passvalue;
  dynamic passname;
  PurchaseReturn({this.passvalue,this.passname,this.itemrowdata});
...
class _PurchaseReturnState extends State<PurchaseReturn> {
  ...
  static List<Pur_Rtn_Dtls_Model> PurRtnMdl = new List<Pur_Rtn_Dtls_Model>();
  ...
  Pur_Rtn_Dtls_Model _Pur_rtn_mdl;
...
//      print(response.statusCode);
  ...
  GetVchnum()async {
    try {
      final response =
      await http.get("${Env.baseUrl}getSettings/1/gtpurchasertn", headers: {
        "Authorization": user.user["token"],
      });
      print(response.statusCode);
...
//--------------------Print part-------------------------------------------
  ...
  GetdataPrint(id) async {
    ...
    try {
      final tagsJson =
      await http.get("${Env.baseUrl}PurchaseRtnHeaders/$id", headers: {
        //Soheader //PurchaseRtnHeaders
        "Authorization": user.user["token"],
      });
