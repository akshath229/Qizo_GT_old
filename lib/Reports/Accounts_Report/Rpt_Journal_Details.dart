...
// ledger balance page
class Journal_Details_Report extends StatefulWidget {

  @override
  _Journal_Details_Report createState() => _Journal_Details_Report();
}

class _Journal_Details_Report extends State<Journal_Details_Report>
  ...
  GetRpt()async{
    ...
    try {
      final res =await cw.post(api:"Journal",body: jsonParse,Token: token);
      if(res!=false) {
        setState(() {
          print(res);
...
//    key: scaffoldKey,
        appBar: PreferredSize(
            ...
            child:  Appbarcustomwidget(uname: userName, branch: branchName, pref: pref, title:"Journal Details")
        ),
...
//                            errorBorder:InputBorder.none ,
                      ...
                      onSuggestionSelected: (suggestion) {
                        ...
                        print("selected");
                        print(suggestion["id"]);
                        PaymentTypController.text = suggestion["name"];
