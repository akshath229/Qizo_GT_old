...
// ledger balance page
class Receipt_Details_Report extends StatefulWidget {

  @override
  _Receipt_Details_Report createState() => _Receipt_Details_Report();
}

class _Receipt_Details_Report extends State<Receipt_Details_Report>
  ...
  GetSalesRpt()async{
    ...
    try {
      final res =await cw.post(api:"Receipt",body: jsonParse,Token: token);
      if(res!=false) {
        setState(() {
          print(res);
...
//    key: scaffoldKey,
        appBar: PreferredSize(
            ...
            child:  Appbarcustomwidget(uname: userName, branch: branchName, pref: pref, title:"Receipt Details")
        ),
