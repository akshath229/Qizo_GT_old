...
class Purchase_Report extends StatefulWidget {
  ...
  @override
  _Purchase_Report createState() => _Purchase_Report();
}

class _Purchase_Report extends State<Purchase_Report>
  ...
  getItemIndex(dynamic item) {
    var index = Purchase_Data.indexOf(item);
    return index + 1;
  }
  ...
  GetPurchaseRpt()async{
    ...
    try {
      final res =
      await cw.post(api:"GtPurchase",Token:token,body:jsonParse,deviceId:user.deviceId);
      if(res!=false) {
        print(res);
        setState(() {
          var parseJson = json.decode(res);
          Purchase_Data=parseJson["details"]["data"];
        });
...
//    key: scaffoldKey,
        appBar: PreferredSize(
            ...
            child:  Appbarcustomwidget(uname: userName, branch: branchName, pref: pref, title:"Purchase Report")
        ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Visibility(
                    visible:Purchase_Data.length>0 ,
                              ...
                              cells: [
                                ...
                                DataCell(
                                  Container(
                                    ...
                                    Alignment.centerRight,
                                    child: Text(
                                        itemRow['Amount'].toStringAsFixed(2)),
                                  ),
                                  showEditIcon: false,
                                  placeholder: false,
                                ),
