...
// ledger balance page
class Salesmanwise_Sales_Report extends StatefulWidget {

  @override
  _Salesmanwise_Sales_Report createState() => _Salesmanwise_Sales_Report();
}

class _Salesmanwise_Sales_Report extends State<Salesmanwise_Sales_Report>
  ...
  var Salesmanwise_Sales_Report_Data=[];
  ...
  getItemIndex(dynamic item) {
    var index = Salesmanwise_Sales_Report_Data.indexOf(item);
    return index + 1;
  }
  ...
  Get_Slsmanwise_Sales_Report()async{
    var parm={
    ...
    print(jsonParse);
    try {
      final res =await cw.post(api:"GtSales/4",Token:token,body:jsonParse,deviceId:user.deviceId);
      print(res);
      if(res!=false) {
        setState(() {
          print(res);
          var c = json.decode(res);
          Salesmanwise_Sales_Report_Data=c["details"]["data"];
        });

      }
      else{
        setState(() {
          Salesmanwise_Sales_Report_Data.clear();
        });
      }
    } catch (e) {
      print("error on $e");
  ...
  Clear(){
    ...
    setState(() {
      Salesmanwise_Sales_Report_Data=[];
...
//    key: scaffoldKey,
        appBar: PreferredSize(
            ...
            child:  Appbarcustomwidget(uname: userName, branch: branchName, pref: pref, title:"Salesmanwise Sales")
        ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Visibility(
                    visible:Salesmanwise_Sales_Report_Data.length>0 ,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => Dynamic_Pdf_Print(
                                Parm_Id: 29,
                                Details_Data: Salesmanwise_Sales_Report_Data,
                                title:"SALES REPORT" ,
...
// ----------------------table------------------
          ...
          Container(
            child: Salesmanwise_Sales_Report_Data.length > 0
                ? Row(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: DataTable(
                          ...
                          rows: Salesmanwise_Sales_Report_Data
                              .map(
                                (itemRow) => DataRow(
                              cells: [
                                DataCell(
