...
// ledger balance page
class Sales_Rtn_Report extends StatefulWidget {

  @override
  _Sales_Rtn_Report createState() => _Sales_Rtn_Report();
}

class _Sales_Rtn_Report extends State<Sales_Rtn_Report>
  ...
  getItemIndex(dynamic item) {
    var index = Sales_Rtn_Data.indexOf(item);
    return index + 1;
  }
  ...
  GetPurchaseRpt()async{
    ...
    print(jsonParse);
    try {
      final res =await cw.post(api:"GTSalesReturn/1",Token:token,body:jsonParse,deviceId:user.deviceId);
      print(res);
      if(res!=false) {
        setState(() {
          print(res);
          var c = json.decode(res);
          Sales_Rtn_Data=c["details"]["data"];
        });

      }
      else{
        setState(() {
          Sales_Rtn_Data.clear();
        });
      }
    } catch (e) {
      print("error on $e");
...
//    key: scaffoldKey,
        appBar: PreferredSize(
            ...
            child:  Appbarcustomwidget(uname: userName, branch: branchName, pref: pref, title:"Sales Return Report")
        ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Visibility(
                    visible:Sales_Rtn_Data.length>0 ,
                        ...
                        child: DataTable(
                          ...
                          rows: Sales_Rtn_Data
                              ...
                              cells: [
                                ...
                                DataCell(
                                  Text(
                                      itemRow['Rtn.Voucher'].toString()),
                                  showEditIcon: false,
                                  placeholder: false,
                                ),
                                DataCell(
                                  Text(itemRow['Rtn.Date']
                                      .toString()),
                                  showEditIcon: false,
                                  placeholder: false,
                                ),
                                ...
                                DataCell(
                                  Text(
                                      itemRow['Sales Invoice'].toString()),
                                  showEditIcon: false,
                                  placeholder: false,
                                ),
