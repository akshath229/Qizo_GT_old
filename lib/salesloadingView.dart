...
import 'package:flutter_app/models/postsalesloadingview.dart';
import 'package:flutter_app/models/salesloadingviewres.dart';
...
//            ));
  ...
  getSalesLoadingView() async {
    var res = await http.get(
        "${Env.baseUrl}TsalesOrderHeaders/${this.widget.id}/3",
...
class SalesLoad {
  String itemName;
  List<dynamic> qrCodes = new List<dynamic>();

  SalesLoad({this.itemName, this.qrCodes});
}
