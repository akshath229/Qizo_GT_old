...
import 'package:flutter_app/frontPage.dart';
import 'package:flutter_app/godownuserhome.dart';
import 'package:device_info/device_info.dart';
import 'package:flutter_app/urlEnvironment/urlEnvironment.dart';
import 'package:flutter/material.dart';
...
import 'package:flutter_app/technicianhome.dart';
          ...
          if(s.data.containsKey("userData")){
            try {
              ...
              print("json.encode(user)");
               print(json.encode(user));
              // print(json.encode(user.appType));
              ...
              // if (aptyp == 'RMS' ) return Rms_Homes2(username: user.user['userType'].toString());
              // if (aptyp == 'GT') return SalesManHome();
              if (aptyp == 'GT') return Rms_Homes2(username: user.user['userType'].toString());
              print("the value issss s " + user.user['userType'].toString().toLowerCase());
              if (aptyp == 'GT' && user.user['userType'].toString().toLowerCase()=="sales") return Rms_Homes2();
