...
import 'package:flutter_app/models/expenseCollection.dart';
import 'package:flutter_app/models/expenseSheet.dart';
...
class _State extends State<ExpenseSheetSalesMan> {
  ...
  static List<ExpenseAdd> expenseAd = new List<ExpenseAdd>();
  ExpenseAdd expense;
  String noImage = "-No Image-";

  static List<ExpenseCollect> expenseCollections = new List<ExpenseCollect>();
