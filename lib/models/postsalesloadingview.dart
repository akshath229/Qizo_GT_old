...
class SalesLoadingViewPostData {
  ...
  SalesLoadingViewPostData({this.tldItemId, this.tldQty,this.relSalesLoadingBarcodeDetails});
...
class RelSalesLoadingBarcodeDetails {
  String slbBarcode;
  int SlbLoadingDetailsId;

  RelSalesLoadingBarcodeDetails({this.slbBarcode,
  this.SlbLoadingDetailsId});
