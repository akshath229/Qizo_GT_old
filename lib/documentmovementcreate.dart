...
//            ));
  ...
  getVoucherNumber() async {
    var res = await http.get(
        "${Env.baseUrl}TDocumentHandlingdetails/${this.widget.data['id'].toString()}/1",
...
//      maxProgress: 100.0,
      ...
      if (checkedValue) {
        ...
        var params = json.encode(req);
        print(params);
        var res = await http.post('${Env.baseUrl}TDocumentHandlingdetails',
            headers: {
              'accept': 'application/json',
              'content-type': 'application/json',
              'Authorization': user.user['token'],
