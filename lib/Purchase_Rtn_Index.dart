...
class Purchase_Rtn_Index extends StatefulWidget {
  @override
  _Purchase_Rtn_IndexState createState() => _Purchase_Rtn_IndexState();
}

class _Purchase_Rtn_IndexState extends State<Purchase_Rtn_Index> {
  @override
  void initState() {
...
//get data to list
  ...
  getindexdata()async{
    try {
      var res = await http.get("${Env.baseUrl}PurchaseRtnHeaders",
...
//      key: scaffoldKey,
          appBar: PreferredSize(
              ...
              child:  Appbarcustomwidget(uname: userName, branch: branchName, pref: pref, title:"Purchase Return Index")
          ),
          body: ListView(children: <Widget>[
            ...
            Container(
              ...
              width: 350,
              child: Center(
                  child:Text("Loading Purchase Return....")
