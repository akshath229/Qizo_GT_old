                                  ...
                                  child: Padding(
                                    ...
                                    child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        setState(() {
                                          if (Pay_Typ_Tota_Amt_Controller.text ==
                                              "0.0") {
                                            setState(() {
                                              print("inn");
                                              TotalAmtController.text =
                                            ...
                                            Padding(
                                              ...
                                              child: RaisedButton(
                                                ...
                                                onPressed: () {
                                                  ...
                                                  if(customerController.text!="" && Pay_Typ_Credit_Ph_Controller.text!="")
                                                  {
                  ...
                  itemBuilder: (c, i) {
                    return Padding(
                      ...
                      child: RaisedButton(
                        ...
                        child: Stack(
                          children: [
                            Image.network((btnItmLst[i]["itmImage"]) ==
                                null ||
