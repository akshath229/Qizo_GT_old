...
import 'package:flutter_app/models/shopvisitswithdate.dart';
import 'package:flutter_app/receiptcollection.dart';
import 'package:flutter_app/receiptcollectionindex.dart';
...
import 'package:flutter_app/shopvisitIndex.dart';
  ...
  class shopvisited extends StatefulWidget {
    int passvalue;
  dynamic passname;
  shopvisited({this.passvalue,this.passname});
...
//        });
  ...
  getCustomerRegistered(dynamic ledgerId) async {
    ...
    var res = await http.get(
        "${Env.baseUrl}RelMcustLedgerLocations/${ledgerId}/1",
