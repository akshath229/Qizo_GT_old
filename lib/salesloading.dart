...
import 'package:flutter_app/models/salesorderres.dart';
import 'package:flutter_app/models/userdata.dart';
import 'package:flutter_app/salesloadingView.dart';
...
class _SalesLoadingState extends State<SalesLoading> {
  ...
  List<SalesOrderRes> salesOrdRes = new List<SalesOrderRes>();
...
//            ));
  ...
  getSalesOrder() async {
    var res = await http.get("${Env.baseUrl}TsalesOrderHeaders/0/4",
