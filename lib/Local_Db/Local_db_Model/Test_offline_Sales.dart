...
import 'package:flutter_app/HandleLocalDB.dart';
...
class Ofline_Sales extends StatefulWidget {

  dynamic itemrowdata=[];
  int passvalue;
  dynamic passname;
  Ofline_Sales({this.passvalue,this.passname,this.itemrowdata});




  @override
  _Ofline_SalesState createState() => _Ofline_SalesState();

}

class _Ofline_SalesState extends State<Ofline_Sales> {
...
//--------------------------Barcode Reader----------------------
  ...
  SelectedRows(bool stsus,LD_Model_ItemMaster data)async{
    print("SelectedRows");
...
//                    ),
  ...
  ItemPushToArray(LD_Model_ItemMaster data,qty){
  ...
  databinding(id) async{
    ...
    try {
      ...
      setState(() {
        ...
        paymentTypeController.text=tagsJson["salesHeader"][0]["paymentType"].toString()=="Cash"?
        "Cash":"Credit";
      });
