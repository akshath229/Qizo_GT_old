...
import 'package:flutter_app/GT_Masters/Printing/Gst_Print_Foramt.dart';
...
import 'package:flutter_app/Local_Db/Local_db_Model/LD_Model_GeneralSettings.dart';
...
import 'package:flutter_app/models/finishedgoods2.dart';
...
class Ofline_Sales2 extends StatefulWidget {
  ...
  int passvalue;
  dynamic passname;
  Ofline_Sales2({this.passvalue,this.passname,this.itemrowdata});
  @override
...
class _Ofline_Sales2State extends State<Ofline_Sales2> {
  ...
  List<TextEditingController> _ccontrollers = new List();
  List<TextEditingController> _bcontrollers = new List();
...
//   validation variables
  ...
  static List<Amoun> Amount = new List<Amoun>();
