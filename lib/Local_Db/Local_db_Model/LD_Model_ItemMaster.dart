...
class LD_Model_ItemMaster {
  ...
  factory LD_Model_ItemMaster.fromJson(Map<String, dynamic> json) => LD_Model_ItemMaster(
    id: json["id"],
    ...
    nos: json["nos"],
    itmHsn: json["itmHsn"],
    itmTaxInclusive: json["itmTaxInclusive"]==0?false:true,
...
//     this.itmPrintCaption,
//     this.itmTaxInclusive,
//     this.txTypDescription,
//     this.itmTaxId,
//     this.txDescription,
//     this.txPercentage,
//     this.txCgstPercentage,
