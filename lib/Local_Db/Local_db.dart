...
import 'package:flutter_app/Local_Db/GetDatas_FromServer.dart';
...
import 'package:flutter_app/Local_Db/Local_db_Model/LD_Model_amount.dart';
...
class Local_Db{
  ...
  Inser_Server_data({String TableName,data})async{
...
//--------------------Sales Post-----------------
  ...
  Insert_Sales_data({String TableName,LD_Model_Sales data})async{
