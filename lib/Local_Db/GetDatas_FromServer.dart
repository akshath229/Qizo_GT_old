...
class GetData_FromServer{
  ...
  static List<Customer> Ledg_custmoer = new List<Customer>();
  static List<FinishedGoods> goods = new List<FinishedGoods>();
  static List<Godown> Gdwn = new List<Godown>();
  static List<LD_Model_Company> cmpny = new List<LD_Model_Company>();
  static List<LD_Model_Generalset> GrlSet = new List<LD_Model_Generalset>();

  GetPref()async{

    var  pref=await SharedPreferences.getInstance() ;

    var prefres=await pref.get("userData");
  ...
  List <dynamic> Unit_tagsJsons;
  List <dynamic> Unit_tagsJson;
  List <dynamic> Godowm_tagsJson;
  List <dynamic> Item_tagsJson;
  List <dynamic> LedgerHead_tagsJson;
  List <dynamic>Company_tagsJson;
  ...
  GetUnit_Servers()async{
    ...
    try {
      final res =
      await http.get(url, headers: {"Authorization": pref.user["token"]});
      // print("Units");
      // print(res.body);
