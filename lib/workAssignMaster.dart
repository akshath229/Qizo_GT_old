...
class _workAssignMasterState extends State<workAssignMaster> {
  static List<EmpName> users = new List<EmpName>();
  static List<project> prj = new List<project>();
  static List<moduledata> module = new List<moduledata>();
...
//              content: Text("user data:   " + user.user["token"]),
  ...
  GetEmp() async {
    try {
      final res = await http.get("${Env.baseUrl}MemployeeMasters", headers: {
                    ...
                    child: TypeAheadField(
                        textFieldConfiguration: TextFieldConfiguration(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelText:
                                  'Search Employee', // i need to decrease height
                            )),
                    ...
                    child: TypeAheadField(
                        textFieldConfiguration: TextFieldConfiguration(
                            ...
                            decoration: InputDecoration(
                              ...
                              // i need very low size height
                              labelText:
                                  'Search Project', // i need to decrease height
                            )),
                        suggestionsBoxDecoration:
                            SuggestionsBoxDecoration(elevation: 90.0),
                        suggestionsCallback: (pattern) {
                          return prj.where((prj) => prj.mpProjectName
                              .toUpperCase()
                              .contains(pattern.toUpperCase()));
                        },
                        itemBuilder: (context, suggestion) {
                    ...
                    child: TypeAheadField(
                        textFieldConfiguration: TextFieldConfiguration(
                            ...
                            decoration: InputDecoration(
                              ...
                              // i need very low size height
                              labelText:
                                  'Search  Module', // i need to decrease height
                            )),
                        suggestionsBoxDecoration:
                            SuggestionsBoxDecoration(elevation: 90.0),
                        suggestionsCallback: (pattern) {
                          return module.where((module) => module.pmModuleName
                              .toUpperCase()
                              .contains(pattern.toUpperCase()));
                        },
                        itemBuilder: (context, suggestion) {
...
//
                    ...
                    onTap: () async {
                      ...
                      if (date != null) {
                        ...
                        if ((date.isBefore(
                            chkdate == null ? chkdate = date : chkdate))) {
                ...
                Expanded(
                    child: TypeAheadField(
                        textFieldConfiguration: TextFieldConfiguration(
                            ...
                            decoration: InputDecoration(
                              errorStyle: TextStyle(color: Colors.red),
                              errorText: projMngSelect
                                  ? "Please Select proj Mng?"
                                  : null,
                              suffixIcon: IconButton(
                                icon: Icon(Icons.remove_circle),
                                color: Colors.blue,
                              ...
                              // i need very low size height
                              labelText:
                                  'Search Project Managed By', // i need to decrease height
                            )),
                        suggestionsBoxDecoration:
                            SuggestionsBoxDecoration(elevation: 90.0),
                        suggestionsCallback: (pattern) {
...
class EmpName {
  ...
  EmpName({this.id, this.emEmployeeName});
...
class project {
  ...
  project({this.id, this.mpProjectName});
...
class moduledata {
  ...
  moduledata({this.id, this.pmModuleName});
