...
import 'package:flutter_app/AQizo_RMS/Rms_ItemMaster.dart';
import 'package:flutter_app/AQizo_RMS/Rms_MakeOrder.dart';
import 'package:flutter_app/AQizo_RMS/itemBill.dart';
import 'package:flutter_app/Add_BaseUrl.dart';
import 'package:flutter_app/AudioRecorde.dart';
...
import 'package:flutter_app/Local_Db/Local_db_Model/Test_offline_Sales.dart';
import 'package:flutter_app/Local_Db/Local_db_Model/Test_offline_Sales2.dart';
...
import 'package:flutter_app/ReceiptCollections_Direct2.dart';
import 'package:flutter_app/Reports/Report_Home.dart';
import 'package:flutter_app/Sales_Rtn_Index.dart';
import 'package:flutter_app/Salesreturn2.dart';
import 'package:flutter_app/StocksView.dart';
import 'package:flutter_app/Testing/Test3.dart';
import 'package:flutter_app/Testing/Test4.dart';
import 'package:flutter_app/Testing/TestRescPatPdfPrint.dart';
...
import 'package:flutter_app/Utility/ledgerBalanceCreate2.dart';
...
import 'package:flutter_app/models/SalesOrder.dart';
...
import 'package:flutter_app/salesorderindexpage.dart';
...
class _Rms_Homes2State extends State<Rms_Homes2> {
  ...
  getVersion() async {
    var res = await http.get('${Env.baseUrl}MobVersion',
...
/*Show dialog if GPS not enabled and open settings location*/
  ...
  directURL() async {
    print("Direct to...");
    var res = await http.get("${Env.baseUrl}getSettings/1/c",
        headers: {'Authorization': user.user['token']});
                        ...
                        child: Stack(
                          ...
                          children: [
                            Padding(
                                ...
                                ,
                                child: Icon(
                                  icon[i], size: 40, color: Colors.indigo,)),
                            // SizedBox(
                            //   width: 4,
                            // ),
                        ...
                        Container(
                            ...
                            child: Align(alignment: Alignment.center,
                              child: Text((textTitle),
                                  style: TextStyle(
                                      fontSize: 25.0, color: (txtclr))
                              ),
                            ),
                            decoration: new BoxDecoration(
                                image: new DecorationImage(
                                  image: new AssetImage('assets/attndance.jpg'),
                                  fit: BoxFit.fill,
...
test()async{
  ...
  var res=await http.get("http://alnashath.qizo.in/api/Englishes/120611");
  print(res.body);
}
///-------------------------------------old button------------------------------
