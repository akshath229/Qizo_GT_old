...
class _Rms_MakeOrderState extends State<Rms_MakeOrder> {
  ...
  static List<Rms_MakeOrder_Details> MOD = new List<Rms_MakeOrder_Details>();
  ...
  var UomTableData = {};
  dynamic UOM = null;
  Rms_MakeOrder_Details ItmBLdata;
  dynamic itemQty = 0;
                        ...
                        itemBuilder: (c, i) {
                          return Padding(
                            ...
                            child: RaisedButton(
                              ...
                              color:SelectedItemGrp==i?Colors.blueAccent.shade700: Color.fromARGB(255, 175, 211, 246),
                              onPressed: () {
                                if (TablenumController.text == "") {
                                  setState(() {
                                    TablenumValid = true;
                      ...
                      itemBuilder: (c, i) {
                        return Padding(
                          ...
                          child: RaisedButton(
                            splashColor: Colors.blueAccent,
                            hoverColor: Colors.grey.shade400,
                            color:SelectedItem==i?Colors.indigo: Color.fromARGB(255, 175, 211, 246),
                            onPressed: () {
                              print("index :  " +
