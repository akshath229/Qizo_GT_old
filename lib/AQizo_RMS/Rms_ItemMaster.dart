...
import 'package:flutter_app/GT_Masters/Masters_UI/Unit_create_CW.dart';
import 'package:flutter_app/GT_Masters/Masters_UI/cuWidgets.dart';
import 'package:flutter_app/GT_Masters/Models/Items.dart';
import 'package:flutter_app/GT_Masters/Models/Tax_master.dart';
import 'package:flutter_app/GT_Masters/Models/Unit_model.dart';
...
class Rms_ItemMaster extends StatefulWidget {

  String Btn_Name;
  dynamic data;

  Rms_ItemMaster({@required this.Btn_Name, @required this.data});
  @override
  _Rms_ItemMasterState createState() => _Rms_ItemMasterState();
}

class _Rms_ItemMasterState extends State<Rms_ItemMaster> {
...
// //----------------------------------
  ...
  static List<StockType> sttyp = new List<StockType>();
  static List<ProductType> prodtyp = new List<ProductType>();
  static List<Tax> taxlist = new List<Tax>();
