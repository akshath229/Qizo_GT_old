...
class Rms_Test1 extends StatefulWidget {
  var Parm_Id;
  var Page_Type;
  Rms_Test1({this.Parm_Id,this.Page_Type});

  @override
  _Rms_Test1State createState() => _Rms_Test1State();
}

class _Rms_Test1State extends State<Rms_Test1> {
...
//------------------for appbar------------
  ...
  GetdataPrint(id) async {
    ...
    try {
      final tagsJson =
      await http.get("${Env.baseUrl}SalesHeaders/57", headers: {
        //Soheader //SalesHeaders
        "Authorization": user.user["token"],
      });
