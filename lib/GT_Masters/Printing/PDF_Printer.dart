...
class Pdf_Print extends StatefulWidget {
  var Parm_Id;
  var Page_Type;
  Pdf_Print({this.Parm_Id,this.Page_Type});
...
//------------------for appbar------------
  ...
  GetdataPrint(id) async {
    ...
    try {
      ...
      if(dataForTicket['salesHeader'][0]["ledgerId"]!=null) {
        ...
        print("the ledger balance is " + LedgerBalance.toString());
      }
      setState(() {
        IsArabic=false;
      });
  ...
  GetLedgerBalance(id,DateTime Vchdate)async{
    ...
    print("the id is " + id.toString() + "the for" + formattedDate.toString());
   ...
   //   print("url:" + url);
    ...
    //  print(response.body.toString());
        ...
        print("the return part is " );
        print(_LgrBlnce.toString());
        return _LgrBlnce;
      } catch (e) {
        print("error" + e);
      }
  ...
  Widget build(BuildContext context) {
    ...
    print("inside the build" + ScreenSize.toString() + " " + ScreenHeight.toString() + " " + dataForTicket.toString() + " " + Companydata.toString());
    ...
    return
      SafeArea(
        child: Scaffold(
          ...
          // Companydata == null ? SizedBox(height: ScreenHeight ,width: ScreenSize,
          //     child: Center(child: Text("Loading..."))) :
  ...
  Future<Uint8List> _generatePdfA4(PdfPageFormat format,
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        margin:pw.EdgeInsets.only(top: 20,left: 25,bottom: 20,right: 25),
        ...
        build: (pw.Context context) {
          ...
          pw.Column(children: [
            ...
            pw.Table.fromTextArray(
                ...
                cellAlignments:IsArabic==true? {1: pw.Alignment.centerRight,7:pw.Alignment.centerRight}: {1: pw.Alignment.centerLeft,},
                ...
                headerAlignments:IsArabic==true? {1: pw.Alignment.centerRight,7:pw.Alignment.centerRight}: {1: pw.Alignment.centerRight},
                      ...
                      pw.Align(alignment: pw.Alignment.topLeft,
                        child:pw.Flex(crossAxisAlignment: pw.CrossAxisAlignment.start,
                            ...
                            children: [
                              ...
                              LgrBalanceShow==true?   pw.Text(" ) $VchDate       كما في( :   $LedgerBalance$opType الرصيد الختامي",style: pw.TextStyle(fontSize: Pdf_fontSize,font: ttf),
                                textDirection: pw.TextDirection.rtl,):pw.Text(""),
...
pw.Column(
    ...
    children: [
      pw.Text("Total Quantity      :  $TotalQty",style: pw.TextStyle(fontSize: Pdf_fontSize)),
      LgrBalanceShow==true? pw.Text("Current Balance   : $LedgerBalance $opType (As on : $VchDate)  ",style: pw.TextStyle(fontSize: Pdf_fontSize))
      :pw.Text("")
      ,

      pw.Text("$AmtInWrds",style: pw.TextStyle(fontSize: Pdf_fontSize)),
                     ...
                     pw.Spacer(),
                      ...
                      pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text("${AmountBeforeTax.toStringAsFixed(2)} : ",style: pw.TextStyle(fontSize: 10,font: ttf),textDirection: pw.TextDirection.ltr,),
                            ...
                            TotalTax.toStringAsFixed(2)} : ",style: pw.TextStyle(fontSize: 10,font: ttf),textDirection: pw.TextDirection.ltr),



                            pw.Text("${dataForTicket['salesHeader'][0]["amount"]==null?0.toStringAsFixed(2):
                            dataForTicket['salesHeader'][0]["amount"].toStringAsFixed(2)} : ", style: pw.TextStyle(font: ttf,fontSize: 15,fontWeight: pw.FontWeight.bold),textDirection: pw.TextDirection.ltr),
                          ]),
...
//             pw.Text("Current Balance   : $LedgerBalance (As on : $VchDate)",
//                 style: pw.TextStyle(fontSize: Pdf_fontSize))
//
//             ) : pw.Text("")
//
//          :
//               LgrBalanceShow == true ? pw.Align(
//                   alignment: pw.Alignment.bottomRight,
//                   child: pw.Text(
//                       "  الرصيد الحالي ) كما في $LedgerBalance ( $VchDate : ",
//                       style: pw.TextStyle(fontSize: Pdf_fontSize, font: ttf),
//                       textDirection: pw.TextDirection.rtl)) : pw.Text(""),
//
//
  ...
  Future<Uint8List> _generatePdf3Inch(PdfPageFormat format,
    ...
    pdf.addPage(
      pw.Page(
        margin:pw.EdgeInsets.only(top: 10,left: 10,bottom: 10,right: 10),
...
///--------------------------------24-02-2022---without-MultiPage Pdg-------------------------------------------
// import 'dart:convert';
// import 'dart:typed_data';
//
// import 'package:flutter/material.dart';
...
//            // height:PgA4==true?null:ScreenSize/3,
