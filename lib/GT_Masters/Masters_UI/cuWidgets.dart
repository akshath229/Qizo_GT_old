...
class CUWidgets {
  ...
  CUget({String api}) async {
    try {
      var result = await http.get('${Env.baseUrl}$api',
  ...
  CUshowDialog(context,{String label="",labelcolor=Colors.black,VoidCallback clickFunction }) {
  ...
  CUget_With_Parm({String api,Token}) async {
    try {
      print("token" +Token);
      var result = await http.get('${Env.baseUrl}$api',
          headers:{"accept": "application/json",
  ...
  post({String api, Token,  body, deviceId}) async {
    try {
      var result = await http.post('${Env.baseUrl}$api',
          headers: {
  ...
  put({String api, Token,  body, deviceId}) async {
    try {
      var result = await http.put('${Env.baseUrl}$api',
          headers: {
            'accept': 'application/json',
            'content-type': 'application/json',
            'Authorization':Token,
  ...
  delete({String api, Token, deviceId}) async {
    try {
      var result = await http.delete('${Env.baseUrl}$api',
          headers: {
            'accept': 'application/json',
            'content-type': 'application/json',
            'Authorization':Token,
