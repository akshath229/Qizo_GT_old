...
class SalesReturn2 extends StatefulWidget {
  ...
  int passvalue;
  dynamic passname;
  SalesReturn2({this.passvalue,this.passname,this.itemrowdata});
...
class _SalesReturn2State extends State<SalesReturn2> {
  ...
  static List<SalesRtnModel> SlsRtnMdl = new List<SalesRtnModel>();
...
//                    ),
  ...
  EditBindingData(id)async{
    ...
    try {
      final tagsJson =
      await http.get("${Env.baseUrl}SalesRtnHeaders/$id", headers: {
        //Soheader //SalesHeaders
        "Authorization": user.user["token"],
      });
