...
class ReceiptCollections_Direct2 extends StatefulWidget {

  int passvalue;
  dynamic passname;
  ReceiptCollections_Direct2({this.passvalue,this.passname});



  @override
  _ReceiptCollections_Direct2State createState() => _ReceiptCollections_Direct2State();
}

@override
class _ReceiptCollections_Direct2State extends State<ReceiptCollections_Direct2> {
...
//   "Select Customer";
  ...
  GetVchnum()async{
    ...
    try {
      final tagsJson =
      await http.get("${Env.baseUrl}getSettings/1/receiptvoucher", headers: {
...
//     );
    ...
    var res = await http.post("${Env.baseUrl}TaccReceiptHeaders",
        headers: {
...
//--------------------------Edit part----------------------------------
  ...
  EditBinde(id)async{
    ...
    print("uiouiouioiu");
    print(id.toString());
    var res = await http.get("${Env.baseUrl}TaccReceiptHeaders/$id",
        headers: {
          'accept': 'application/json',
          'content-type': 'application/json',
          'Authorization': user.user["token"],
...
//            content: Text("$customerName"),
    ...
    var map = json.encode(req);
    print(map);
    var res = await http.put("${Env.baseUrl}TaccReceiptHeaders/${widget.passvalue}",
        headers: {
          'accept': 'application/json',
          'content-type': 'application/json',
          'Authorization': user.user["token"],
...
//--------------------Print part-------------------------------------------
  ...
  GetPrintData()async{
    ...
    var res = await http.get("${Env.baseUrl}TaccReceiptHeaders/6",
        headers: {
          'accept': 'application/json',
          'content-type': 'application/json',
          'Authorization': user.user["token"],
...
class Receipt_Payment_Add {
  ...
  Receipt_Payment_Add({this.slNo,this.receivedAmount,
    this.remarks,this.image,this.rdtransactionType,
